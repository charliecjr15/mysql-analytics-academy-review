...
TEXTBOOK_UNITS = [
    ...
    [
        ...
        ("Choosing and Validating a Multi-Step Pattern",15,18,"Readable syntax is not enough: NULL behavior, repeated evaluation, and untested grain can still produce incorrect results. We establish criteria for choosing and debugging each pattern."),
        ("Subquery and CTE Lab",19,22,"The exercises progress from scalar benchmarks to absence tests and share-of-total calculations. Run each intermediate result independently before composing the final statement."),
        ("Chapter Summary",23,23,"Use this summary to compare the shape produced by scalar subqueries, IN, EXISTS, derived tables, and CTEs before moving to window functions."),
    ],
    [
        ...
        ("Comparing Rows Across Time",11,14,"LAG, LEAD, and moving frames turn a daily series into comparisons. The order and frame definition determine which neighboring values participate."),
        ("Shares, Ordering, and Layered Analysis",15,19,"Percentage-of-total and combined grouped/window reports show how analytical stages can be layered. We separate window order from final display order and review failure patterns."),
        ("Window Function Lab",20,24,"These exercises cover ranking, partitioning, top-N logic, revenue share, running totals, and change. State the partition and order in words before writing OVER."),
        ("Chapter Summary",25,25,"Use the summary to choose among grouping, ranking, navigation, and aggregate window functions based on the required output grain."),
    ],
    [
